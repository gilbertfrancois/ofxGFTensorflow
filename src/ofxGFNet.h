...
public:
    ...
    tensorflow::Tensor tensorFromCvImage(const cv::Mat &img_norm, const double scale, const cv::Size size, const int channels);
    
    tensorflow::Tensor tensorFromCvImages(const std::vector<cv::Mat> &images, const double scale, const cv::Size size, const int channels);
